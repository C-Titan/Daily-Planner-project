...
function injectThemes() {
    ...
    for (let i = 0; i < hues.length; i++) {
        css += generateThemeCSS(hues[i], theme_hue_presets[hues[i]])
    }
...
function generateThemeCSS(color, hue) {
    return `
        [data-theme="${color}-light"] {
            ...
            /* Text */
                ...
                --color-links-grey: hsla(0, 0%, 85%, 0.5);

            /* Menus */
                --color-dropdown-menu: hsl(${hue}, 100%, 95%);
        }
        ...
        [data-theme="${color}-dark"] {
            ...
            /* Text */
                ...
                --color-links-grey: hsla(0, 0%, 0%, 0.5);

            /* Menus */
                --color-dropdown-menu: hsl(${hue}, 20%, 20%);
        }
